...
contract FaucetController is AdminControl {
    ...
    function request(address to) external {
		...
		//require(address(this).balance >= amount, "Insufficient or Token value sent is not correct");
    ...
    function deposit(uint256 amountFund) external payable returns (uint256) {
		...
		uint256 _amountFund = amountFund;
		return _amountFund;
    }
